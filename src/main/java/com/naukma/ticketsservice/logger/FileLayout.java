...
@Plugin(name = "FileLayout", category = Node.CATEGORY, elementType = Layout.ELEMENT_TYPE, printObject = true)
public class FileLayout  extends AbstractStringLayout
{
    protected FileLayout( Charset charset ) {
        super( charset );
    }
    ...
    @PluginFactory
    public static FileLayout createLayout(@PluginAttribute(value = "charset", defaultString = "UTF-8") Charset charset) {
        return new FileLayout(charset);
    }
}
